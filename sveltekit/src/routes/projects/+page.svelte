<script>
  ...
  const projects = [
    ...
    {
      title: 'Open Library',
      description: 'Curated collection of opensource components and example apps to help onboard new contributors.',
      image: 'https://picsum.photos/seed/image6/800/450',
      tags: ['Open Source', 'Community'],
      links: { source: 'https://github.com/djtsingh/open-library' }
    }
  ];
</script>
